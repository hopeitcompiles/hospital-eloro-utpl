...
import { registerNewPatient } from "../../../service/PatientService";

import Style from "../css/AddForm.module.css";
export default function AddPatientForm({ editing, onSuccess, onCancel }) {
  ...
  const handleRegister = async (e) => {
    e.preventDefault();
    const response = await registerNewPatient(values);
    if (response) {
      setError("Done");
      if (onSuccess) {
        onSuccess();
