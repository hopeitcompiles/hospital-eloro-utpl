    ...
    <div>
      {showModalImage && (
        <ModalForm setClose={() => handleClose()}>
          <img src={cardUser?.image ? cardUser.image : default_image} />
        </ModalForm>
      )}
      <div
      ...
      >
        <div className={cardStyle.top}>
          <div className={cardStyle.image_container}>
            <img
              src={cardUser?.image ? cardUser.image : default_image}
          ...
          <div className={`${cardStyle.information_display} `}>
            <Link
              ...
              to={`/user/${cardUser.ign ? cardUser.ign : cardUser.id}`}
            >
              <h4>
        ...
        <div className={`${cardStyle.bottom}`}>
          <div className={`${cardStyle.admin_area}`}>
            ...
            <div className={cardStyle.btn_section}>
              ...
              <button
                className={`${cardStyle.inspect} ${cardStyle.no_border_button} `}
              >
                <InspectBtn size={20} />
              </button>
            </div>
